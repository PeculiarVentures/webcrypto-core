...
describe("ECDSA keys", () => {
  ...
  it("Public key", () => {
    ...
    fromJson.fromJSON(json);
    const raw2 = AsnConvert.serialize(fromJson);
    assert.strictEqual(encoding.hex.encode(raw2), "04410420cc0f60fe5fc30f889cbf4a5cd9eb7a632682572b62856098e29b34c288f39014f2271a29221e6f9e849a95da99edcc7e3826cddec2701aafb9479cae146ee2");
  });
});
